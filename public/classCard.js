...
templates['classCard'] = template({"1":function(container,depth0,helpers,partials,data) {
  ...
  return ((stack1 = container.invokePartial(lookupProperty(partials,"flashcard"),depth0,{"name":"flashcard","data":data,"indent":"            ","helpers":helpers,"partials":partials,"decorators":container.decorators})) != null ? stack1 : "");
  ...
  return "<div class=\"card\" class=\"class-card\" data-name=\"name\" data-URI=\""
    ...
    + "</h3>\r\n	\r\n	<button type=\"button\" class=\"more-options\" class=\"hidden\"><i class=\"fas fa-ellipsis-v\"></i></button>\r\n</div>\r\n\r\n	<button type=\"button\" id=\"flashcard-button\">STUDY</button>\r\n    \r\n    <section id=\"flashcards\" hidden>\r\n        <div id=\"modal-backdrop\" class=\"hidden\"></div>\r\n        <div id='prev-button'><i class=\"fas fa-caret-left\"></i></div>\r\n        <div id='next-button'><i class=\"fas fa-caret-right\"></i></div>\r\n        <div id='close-button'><i class=\"fas fa-window-close\"></i></div>\r\n"
    + ((stack1 = lookupProperty(helpers,"each").call(alias1,(depth0 != null ? lookupProperty(depth0,"flashcards") : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 0),"inverse":container.noop,"data":data,"loc":{"start":{"line":14,"column":8},"end":{"line":16,"column":17}}})) != null ? stack1 : "")
